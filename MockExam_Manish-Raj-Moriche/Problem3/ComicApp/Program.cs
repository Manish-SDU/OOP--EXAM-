...
public class Program
{
    public static void Main()
    {
        ...
        try 
        {
            ...
            foreach (var comic in comics.Where(c => c.ReleaseYear < 2000)
            ...
            foreach (var stat in comics.GroupBy(c => c.Author)

            .Select(g => new { Author = g.Key, Count = g.Count() }).OrderByDescending(x => x.Count))
